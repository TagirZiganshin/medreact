    ...
    <div ref={cardRef}>
      <div className="relative h-72 transform transition duration-300 hover:scale-105">
        ...
        >
          ...
          <p className="text-white mb-4 text-shadow font-semibold text-xl text-center max-[96rem]:text-sm mx-40 max-[20rem]:text-xs max-[37.6rem]:mx-10">
            {post.text}
          </p>
          <div className="flex items-center absolute bottom-5 w-full justify-center">
            <p className="inline align-middle text-white text-shadow ml-2 font-medium text-center max-[20rem]:text-xs">
              {post.name}
            </p>
          </div>
        </div>
