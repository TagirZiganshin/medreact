...
const PostDetail = () => {
  ...
  return (
    <div>
      {loading ? (
        <CircleLoader color="white" size={150} className="mx-auto my-20" />
      ) : (
        post && (
          <div
            key={post.id}
            className="container mx-auto px-10 mb-8 max-[30rem]:px-3 max-[30rem]:mb-1"
          >
            <PostContents post={post} />
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-[30rem]:gap-0">
              <div className="col-span-1 lg:col-span-8">
                <CreatePost id={id} onCommentCreated={handleCommentCreated} />
              </div>
